...
class graph_temp extends StatelessWidget {
  ...
  Stream<List<dynamic>> valueStream() async* {
    while (true) {
      ...
      var apiUrl =
          "http://180.180.216.61/final-project/all/flutter_api/nt_node_app_api/temp/1d-temp-api.php";
      ...
      for (var i = 0; i < _loadedData[0].values.length; i++) {
        if (_loadedData[0].values[i][1] == Null) {
          yvalue.add(Null);
        } else {
              ...
              child: Padding(
                ...
                child: StreamBuilder(
                  ...
                  builder: (context, snapshot) {
                    print('render - connter widget temp 1');
